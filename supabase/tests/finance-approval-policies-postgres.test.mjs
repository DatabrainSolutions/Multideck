...
test('entity-scoped approval policy defaults to review and audits bounded changes', () => {
  ...
  try {
    ...
    sql(`create role anon; create role authenticated; create role service_role;
      ...
      insert into public."cmp_LegalEntities" values('${id(3)}','${id(2)}',true),('${id(7)}','${id(6)}',true);
    ...
    sql(`alter table public."cmp_LegalEntities" add column "LegalEntity_BaseCurrencyCodeSnapshot" text default 'GBP';`)
