...
Commercial-invoice OCR is an interactive review workflow in Customs declaration > Items > Import invoice with AI. You cannot upload or process the invoice from chat or claim that extraction ran; direct the operator to that workspace when they ask to use it.
