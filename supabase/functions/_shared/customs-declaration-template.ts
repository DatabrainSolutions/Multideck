...
.export .item .value-row td { height: 16pt; }
.export .item .lists td { min-height: 21pt; height: 21pt; }
...
<main class="page">
  ...
  <section class="item">
    ...
    ${
    isImport
      ? `<table class="goods"><tr><td style="width:50%"><span class="label">[31] Packages - number [6/10], kind [6/9] and shipping marks [6/11]</span><span class="value">{d.items[i].packages}</span></td><td><span class="label">[31] Description of goods [6/8]</span><span class="value">{d.items[i].description}</span></td></tr></table>
    <table class="commodity-row"><tr><td style="width:16%"><span class="label">[33] Commodity [6/14]</span><span class="value-inline"> {d.items[i].commodity}</span></td><td style="width:7%"><span class="label">TARIC [6/15]</span><span class="value-inline"> {d.items[i].taric}</span></td><td style="width:14%"><span class="label">EU add. code(s) [6/16]</span><span class="value-inline"> {d.items[i].euCodes}</span></td><td style="width:14%"><span class="label">National add. code(s) [6/17]</span><span class="value-inline"> {d.items[i].nationalCodes}</span></td><td style="width:7%"><span class="label">UNDG [6/12]</span><span class="value-inline"> {d.items[i].dangerousGoods}</span></td><td style="width:7%"><span class="label">CUS [6/13]</span><span class="value-inline"> {d.items[i].cusCode}</span></td><td><span class="label">[15a] Dispatch [5/14]</span><span class="value-inline"> {d.items[i].dispatchCountry}</span></td><td><span class="label">[17a] Destination [5/8]</span><span class="value-inline"> {d.items[i].destinationCountry}</span></td></tr></table>
    <table class="procedure-row"><tr><td style="width:12%"><span class="label">[37] Procedure [1/10]</span><span class="value-inline"> {d.items[i].procedure}</span></td><td style="width:13%"><span class="label">Add. procedure code(s) [1/11]</span><span class="value-inline"> {d.items[i].additionalProcedures}</span></td><td style="width:25%"><span class="label">[40] Previous documents [2/1]</span><span class="value-inline"> {d.items[i].previousDocuments}</span></td><td><span class="label">[34a] Origin [5/15]</span><span class="value-inline"> {d.items[i].originCountry}</span></td><td><span class="label">[34b] Pref. origin [5/16]</span><span class="value-inline"> {d.items[i].preferentialOrigin}</span></td><td><span class="label">[36] Preference [4/17]</span><span class="value-inline"> {d.items[i].preference}</span></td></tr></table>
    <table class="measure-row"><tr><td><span class="label">[35] Gross mass [6/5]</span><span class="value-inline"> {d.items[i].grossMass}</span></td><td><span class="label">[38] Net mass [6/1]</span><span class="value-inline"> {d.items[i].netMass}</span></td><td><span class="label">[41] Suppl. Units [6/2]</span><span class="value-inline"> {d.items[i].supplementaryUnits}</span></td><td><span class="label">[46] Statistical value [8/6]</span><span class="value-inline"> {d.items[i].statisticalValue}</span></td></tr></table>
    <table class="value-row"><tr><td><span class="label">[42] Item price [4/14]</span><span class="value-inline"> {d.items[i].itemPrice}</span></td><td><span class="label">[43] Valn. Method [4/16]</span><span class="value-inline"> {d.items[i].valuationMethod}</span></td><td><span class="label">[24] Nature of transaction [8/5]</span><span class="value-inline"> {d.items[i].transactionNature}</span></td></tr></table>
    ...
    <table class="lists"><tr><td><span class="label">[47] Calculation of taxes [4/3]</span><span class="value">{d.items[i].taxes}</span></td><td><span class="label">[45] Additions and deductions [4/9]</span><span class="value">{d.items[i].adjustments}</span></td></tr></table>`
      : `<table class="goods"><tr><td style="width:50%"><span class="label">[31] Packages - number [6/10], kind [6/9] and shipping marks [6/11]</span><span class="value">{d.items[i].packages}</span></td><td style="width:25%"><span class="label">[31] Description of goods [6/8]</span><span class="value">{d.items[i].description}</span></td><td><span class="label">CUS code [6/13]</span><span class="value">{d.items[i].cusCode}</span></td></tr></table>
    <table class="commodity-row"><tr><td style="width:30%"><span class="label">[33] Commodity [6/14]</span><span class="value-inline"> {d.items[i].commodity}</span></td><td><span class="label">EU add. code(s) [6/16]</span><span class="value-inline"> {d.items[i].euCodes}</span></td><td><span class="label">National add. code(s) [6/17]</span><span class="value-inline"> {d.items[i].nationalCodes}</span></td><td><span class="label">UNDG [6/12]</span><span class="value-inline"> {d.items[i].dangerousGoods}</span></td></tr></table>
    <table class="procedure-row"><tr><td style="width:12%"><span class="label">[37] Procedure [1/10]</span><span class="value-inline"> {d.items[i].procedure}</span></td><td style="width:18%"><span class="label">Add. procedure code(s) [1/11]</span><span class="value-inline"> {d.items[i].additionalProcedures}</span></td><td><span class="label">[7] Reference [2/4]</span><span class="value-inline"> {d.items[i].reference}</span></td></tr></table>
    <table class="measure-row"><tr><td style="width:50%"><span class="label">[40] Simplified declaration/Previous documents [2/1]</span><span class="value">{d.items[i].previousDocuments}</span></td><td><span class="label">[15a] Dispatch [5/14]</span><span class="value-inline"> {d.items[i].dispatchCountry}</span></td><td><span class="label">[17a] Destination [5/8]</span><span class="value-inline"> {d.items[i].destinationCountry}</span></td><td><span class="label">Origin [5/15]</span><span class="value-inline"> {d.items[i].originCountry}</span></td><td><span class="label">Pref. origin [5/16]</span><span class="value-inline"> {d.items[i].preferentialOrigin}</span></td></tr></table>
    <table class="value-row"><tr><td><span class="label">[35] Gross mass [6/5]</span><span class="value-inline"> {d.items[i].grossMass}</span></td><td><span class="label">[38] Net mass [6/1]</span><span class="value-inline"> {d.items[i].netMass}</span></td><td><span class="label">[41] Suppl. Units [6/2]</span><span class="value-inline"> {d.items[i].supplementaryUnits}</span></td><td><span class="label">[46] Statistical value [8/6]</span><span class="value-inline"> {d.items[i].statisticalValue}</span></td><td><span class="label">[42] Item price [4/14]</span><span class="value-inline"> {d.items[i].itemPrice}</span></td><td><span class="label">[S29] Trp MoP [4/2]</span><span class="value-inline"> {d.items[i].freightPaymentMethod}</span></td><td><span class="label">[24] Trans nature [8/5]</span><span class="value-inline"> {d.items[i].transactionNature}</span></td></tr></table>
    <table class="lists"><tr><td><span class="label">[44] Documents, certificates and authorisations [2/3]</span><span class="value">{d.items[i].documents}</span></td></tr></table>
    <table class="lists"><tr><td><span class="label">[44] Additional information [2/2]</span><span class="value">{d.items[i].additionalInformation}</span></td></tr></table>`
  }
