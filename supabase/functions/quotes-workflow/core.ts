...
export type QuoteWorkflowAction = "discard-draft" | "sources" | "charge-catalogue" | "workspace" | "intelligence" | "save" | "transition" | "open" | "readiness" | "convert" | "issue-options" | "issue-draft" | "issue-refine" | "issue-preview" | "issue" | "reference-settings" | "save-reference-settings" | "follow-up-settings" | "save-follow-up-settings" | "draft-reference-rule" | "branding"
...
export function parseAction(value: unknown): QuoteWorkflowAction {
  if (value === "discard-draft") return value
  if (["sources", "charge-catalogue", "workspace", "intelligence", "save", "transition", "open", "readiness", "convert", "issue-options", "issue-draft", "issue-refine", "issue-preview", "issue", "reference-settings", "save-reference-settings", "follow-up-settings", "save-follow-up-settings", "draft-reference-rule", "branding"].includes(String(value))) {
