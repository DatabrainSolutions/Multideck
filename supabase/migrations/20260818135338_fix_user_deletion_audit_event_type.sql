-- Keep user-deletion audit writes inside the registered event taxonomy.
begin;

insert into public."sys_AuditEventTypes" (
  "AuditEventType_Code",
  "AuditEventType_Name",
  "AuditEventType_Description",
  "AuditEventType_IsActive",
  "AuditEventType_SortOrder"
) values (
  'business_event',
  'Business event',
  'A significant domain action recorded outside a row-level audit trigger.',
  true,
  60
)
...
begin
  ...
  perform public."Audit_LogBusinessEvent"(
    'business_event', 'user', p_target_user_id, 'cmp_Users', 'delete',
