...
begin
  ...
  if quote_row."CusQuoteHeader_CustomerID" is null
     and nullif(btrim(quote_row."CusQuoteHeader_CustomerNameSnapshot"), '') is null then
    missing := array_append(missing, 'Customer');
  end if;
