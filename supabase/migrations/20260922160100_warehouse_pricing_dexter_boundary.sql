...
where "AIDexterDomain_Code" in ('warehouse','warehouse_orders','warehouse_inventory','warehouse_items');
...
where "AIDexterWatchCapability_Code" in ('warehouse','warehouse_orders','warehouse_inventory','warehouse_items');
commit;
