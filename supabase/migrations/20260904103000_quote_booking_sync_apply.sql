-- Apply an accepted quote update only after an operator approves specific
-- fields. Partial application remains visibly out of sync until every changed
-- field has been reviewed and applied.
