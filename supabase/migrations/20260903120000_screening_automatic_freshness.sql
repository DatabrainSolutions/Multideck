...
-- GOV.UK retired the OFSI feed on 28 January 2026. Existing snapshots remain
-- historical evidence; only a validated download from UKSL can become usable.
update public."sys_ScreeningListSources" set
  "ScreeningListSource_Name" = 'UK Sanctions List',
  "ScreeningListSource_Publisher" = 'Foreign, Commonwealth & Development Office',
  "ScreeningListSource_DownloadUrl" = 'https://sanctionslist.fcdo.gov.uk/docs/UK-Sanctions-List.csv'
...
set search_path = pg_catalog, public as $$
  ...
  where source."ScreeningListSource_Code" = 'uk_ofsi_consolidated'), '{"loaded":false,"stale":true}'::jsonb);
$$;
...
begin
  ...
  where "ScreeningListSource_Code" = 'uk_ofsi_consolidated' for update;
...
begin
  ...
  where "ScreeningListSnapshot_ID" = p_snapshot_id and "ScreeningListSnapshot_SourceCode" = 'uk_ofsi_consolidated' for update;
  ...
  update public."sys_ScreeningListSnapshots" set "ScreeningListSnapshot_StatusCode" = 'superseded'
    where "ScreeningListSnapshot_SourceCode" = 'uk_ofsi_consolidated'
...
returns void language sql security definer set search_path = pg_catalog, public as $$
  update public."sys_ScreeningListSources" set
    ...
    "ScreeningListSource_RefreshToken" = null, "ScreeningListSource_RefreshExpiresAt" = null
  where "ScreeningListSource_Code" = 'uk_ofsi_consolidated' and "ScreeningListSource_RefreshToken" = p_token;
$$;
...
begin
  ...
  perform 1 from public."sys_ScreeningListSources" where "ScreeningListSource_Code" = 'uk_ofsi_consolidated' for share;
