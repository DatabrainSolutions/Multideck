...
2. `public-schema.sql`
3. `system-reference-data.sql`
4. `storage.sql`
5. the Cloud-owned installation and customer-identity contract
6. only migrations created after this baseline's approved source commit
7. the Edge Functions and Auth settings sealed in the same release manifest
