...
Follow-up: the public-response data boundary and branding defect were subsequently corrected on development; see [the security checkpoint](2026-09-06-quote-public-response-boundary.md). The original observations below are retained as historical test evidence. The issued PDF logo remains unresolved.
