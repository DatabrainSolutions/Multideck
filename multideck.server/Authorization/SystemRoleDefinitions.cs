...
public static class SystemRoleDefinitions
{
    ...
    public static readonly SystemRoleDefinition OperationsManager = new(
        ...
        [
            ...
            AppPermissions.Documents.Read,
            AppPermissions.Documents.Generate,
            AppPermissions.Documents.Manage,
            AppPermissions.Warehouse.Read,
            AppPermissions.Warehouse.Write,
