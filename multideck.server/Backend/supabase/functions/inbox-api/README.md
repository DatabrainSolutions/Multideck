...
```sh
npx --yes deno check Backend/supabase/functions/inbox-api/index.ts
npx --yes deno test Backend/supabase/functions/inbox-api/core_test.ts
node --test Backend/supabase/tests/inbox-api-contract.test.mjs
```
