...
const service = readFileSync(
  resolve(root, "Modules/Inbox/Subscriptions/InboxProviderSubscriptionService.cs"),
  "utf8",
)
const worker = readFileSync(
  resolve(root, "Modules/Inbox/Subscriptions/InboxProviderSubscriptionWorker.cs"),
  "utf8",
)
