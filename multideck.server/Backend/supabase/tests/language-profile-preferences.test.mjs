...
const migration = read(
  "multideck.server/Backend/supabase/migrations/202607310007_user_language_preference.sql",
)
const languageProfileSync = read("multideck.client/src/lib/language-preferences.tsx")
const edgeFunction = read("multideck.server/Backend/supabase/functions/agent-dexter/index.ts")
