...
const emailContext = read(
  "multideck.server/Backend/supabase/functions/agent-dexter/email-context.ts",
)
const emailContextMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802101500_dexter_email_context.sql",
)
const indexedEmailSearchMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802124500_dexter_email_indexed_search_documents.sql",
)
const emailSearchRankingMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802130000_dexter_email_search_ranking.sql",
)
const emailSearchCleanupMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802131500_dexter_email_remove_superseded_index.sql",
)
const watchMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802140000_dexter_watching_for_you.sql",
)
const emailWatchMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802153000_dexter_email_sender_attachment_watches.sql",
)
const emailWatchReliabilityMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802150818_dexter_email_watch_reliability.sql",
)
const inboxLiveSyncMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802155525_inbox_live_sync_latency.sql",
)
const actionableWatchMigration = read(
  "multideck.server/Backend/supabase/migrations/20260802170000_dexter_actionable_watch_updates.sql",
)
const customerDocumentsRuntime = read(
  "multideck.server/Backend/supabase/functions/_shared/customer-documents.ts",
)
const customerDocumentsEdge = read(
  "multideck.server/Backend/supabase/functions/customer-documents/index.ts",
)
...
const emailWatchWorker = read(
  "multideck.server/Backend/supabase/functions/email-watch-worker/index.ts",
)
const inboxRuntime = read(
  "multideck.server/Backend/supabase/functions/inbox-api/runtime.ts",
)
const supabaseConfig = read(
  "multideck.server/Backend/supabase/config.toml",
)
const notificationEmailFunction = read(
  "multideck.server/Backend/supabase/functions/send-notification-email/index.ts",
)
