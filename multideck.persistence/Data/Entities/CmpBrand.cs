...
public partial class CmpBrand
{
    ...
    public Guid? BrandDefaultLegalEntityId { get; set; }

    public string? BrandWebsiteUrl { get; set; }

    public string? BrandPrimaryDomain { get; set; }

    public string? BrandSupportEmail { get; set; }

    public string? BrandLogoFilePath { get; set; }

    public string? BrandPrimaryColor { get; set; }

    public string BrandTemplateSettingsJson { get; set; } = null!;

    public bool BrandIsDefault { get; set; }

    public bool BrandIsActive { get; set; }

    public DateTime BrandCreatedAt { get; set; }

    public Guid? BrandCreatedBy { get; set; }

    public DateTime BrandUpdatedAt { get; set; }

    public Guid? BrandUpdatedBy { get; set; }
    ...
    public virtual CmpLegalEntity? BrandDefaultLegalEntity { get; set; }
