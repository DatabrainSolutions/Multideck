...
const springCheck = read("multideck.client/src/components/multideck/spring-check.tsx")
...
test("task rows use hairlines, optional icon priorities, and accessible completion motion", () => {
  ...
  assert.match(components, /<SpringCheck/)
  assert.match(springCheck, /pathLength=\{1\}/)
  assert.match(components, /useReducedMotion/)
  assert.match(springCheck, /aria-checked=\{on\}/)
  assert.match(springCheck, /disabled=\{disabled \|\| busy\}/)
