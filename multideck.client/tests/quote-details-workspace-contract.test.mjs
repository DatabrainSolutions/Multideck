...
test("every send-blocking Incoterm and Sea FCL container field is visible in quote details", () => {
  ...
  assert.match(details, /className="md-freight-container-row flex min-w-0 flex-wrap items-center gap-2"/u)
  assert.match(workspaceStyles, /\.md-freight-container-row > \.md-compact-field \{ flex: 1 1 260px; \}/u)
