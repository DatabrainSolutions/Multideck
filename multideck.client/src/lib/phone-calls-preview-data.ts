...
const alexDetail: PhoneCallDetail = {
  ...
  participants: [
    ...
    { id: "preview-participant-receptionist", name: "Demo Freight Company receptionist", phone: null, role: "receptionist" },
  ...
  providerReferences: [
    { provider: "elevenlabs", kind: "conversation", id: "conv_preview_demo_freight_1042" },
  ...
  consentDisclosureVersion: "demo-freight-receptionist-v1",
...
function genericDetail(row: PhoneCallListItem): PhoneCallDetail {
  ...
  return {
    ...
    preview: true,
    editVersion: 1,
    summary: row.outcome === "answered" ? `${caller} called about an active shipment and spoke with the customer team.` : null,
    ...
    transcriptSegments: row.transcriptStatus === "pending" ? [] : [
      { id: `${row.id}-segment-1`, source: "elevenlabs", sourceLabel: "ElevenLabs", speakerLabel: "Receptionist", speakerRole: "receptionist", startedAt: row.startedAt, offsetMs: 0, text: "Hi, thanks for calling Demo Freight Company. How can I help today?", state: "complete" },
