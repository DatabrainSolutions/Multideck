...
export const dexterModelPrices: Record<DexterModelId, DexterModelPrice> = {
  fast: { providerModel: "GPT-6 Luna", inputPerMillionUsd: 0.1, outputPerMillionUsd: 0.5 },
  smart: { providerModel: "GPT-6 Luna", inputPerMillionUsd: 0.1, outputPerMillionUsd: 0.5 },
...
const dexterProviderModelPrices: Record<string, DexterModelPrice> = {
  "gpt-6-luna": dexterModelPrices.fast,
  "gpt-5.6-luna": { providerModel: "GPT-5.6 Luna", inputPerMillionUsd: 1, outputPerMillionUsd: 6 },
