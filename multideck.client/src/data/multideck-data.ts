...
export const sidebarAreas: SidebarArea[] = [
  ...
  },
  {
    ...
    icon: ReceiptText,
    destinations: [
      { id: "rates-home", label: "Directions", icon: LayoutDashboard, route: "/rates" },
      { id: "rates-import", label: "Import", icon: Ship, route: "/rates/import" },
      { id: "rates-export", label: "Export", icon: Plane, route: "/rates/export" },
      { id: "rates-cross-trade", label: "Cross trade", icon: Globe2, route: "/rates/cross-trade" },
      { id: "rates-domestic", label: "Domestic", icon: Truck, route: "/rates/domestic" },
    ],
  },
  {
    id: "warehouse",
...
export const galleryComponents = [
  ...
  },
  {
    ...
    foundOn: [{ label: "Overview", route: "/" }, { label: "Bookings", route: "/bookings" }, { label: "Booking detail", route: "/bookings/md-22455" }, { label: "Customers", route: "/customers" }, { label: "Warehouse orders", route: "/warehouse/orders" }, { label: "Rate directions", route: "/rates" }, { label: "Domestic rates", route: "/rates/domestic" }, { label: "Reports", route: "/reports" }, { label: "Settings", route: "/settings" }, { label: "Components", route: "/components" }],
  ...
  },
  {
    ...
    foundOn: [
      ...
      { label: "Rate directions", route: "/rates" },
      { label: "Import rates", route: "/rates/import" },
  ...
  },
  {
    ...
    foundOn: [{ label: "Quote details", route: "/quotes" }, { label: "Import rates", route: "/rates/import" }, { label: "Domestic rates", route: "/rates/domestic" }, { label: "Components", route: "/components?component=multi-select-menu" }],
  ...
  },
  {
    ...
    foundOn: [{ label: "Paper Tray", route: "/paper-tray" }, { label: "Customers", route: "/customers" }, { label: "CRM leads", route: "/crm/leads" }, { label: "Bookings", route: "/bookings" }, { label: "Import rates", route: "/rates/import" }, { label: "Components", route: "/components" }],
  ...
  },
  {
    ...
    foundOn: [{ label: "Customers", route: "/customers" }, { label: "CRM leads", route: "/crm/leads" }, { label: "Bookings", route: "/bookings" }, { label: "Rate directions", route: "/rates" }, { label: "Import rates", route: "/rates/import" }, { label: "Warehouse", route: "/warehouse" }, { label: "Components", route: "/components" }],
  ...
  },
  {
    ...
    foundOn: [{ label: "Quotes", route: "/quotes" }, { label: "Customers", route: "/customers" }, { label: "CRM leads", route: "/crm/leads" }, { label: "Bookings", route: "/bookings" }, { label: "Import rates", route: "/rates/import" }, { label: "Domestic rates", route: "/rates/domestic" }, { label: "Components", route: "/components" }],
  ...
  },
  {
    ...
    name: "Rate Shape Filters",
    category: "Operations",
    description: "The opening rate control: direction first, then mode, then type. Type options follow the selected mode, so FCL and LCL only appear for sea.",
    details: "Use at the top of every rates workspace. Changing direction or mode must reset type to the first valid option for that slice. Source can sit after type on the rate book, but it is not part of the opening choice.",
    foundOn: [{ label: "Rate directions", route: "/rates" }, { label: "Import rates", route: "/rates/import" }, { label: "Export rates", route: "/rates/export" }, { label: "Cross trade rates", route: "/rates/cross-trade" }, { label: "Domestic rates", route: "/rates/domestic" }, { label: "Components", route: "/components?component=rate-shape-filters" }],
    componentCode: `export function RateShapeFilters({ direction, onDirectionChange, mode, onModeChange, shipmentType, onTypeChange }) {\n  return (\n    <section>\n      <FilterChips options={["Import", "Export", "Cross trade", "Domestic"]} activeOption={direction} onChange={onDirectionChange} />\n      <FilterChips options={modeOptions} activeOption={mode} onChange={onModeChange} />\n      <FilterChips options={typeOptions} activeOption={shipmentType} onChange={onTypeChange} />\n    </section>\n  )\n}`,
    usageCode: `<RateShapeFilters\n  directionOptions={["Import", "Export", "Cross trade", "Domestic"]}\n  direction={direction}\n  onDirectionChange={setDirection}\n  modeOptions={modesForDirection(direction)}\n  mode={mode}\n  onModeChange={setMode}\n  typeOptions={typesForDirection(direction, mode)}\n  shipmentType={shipmentType}\n  onTypeChange={setShipmentType}\n/>`,
  },
  {
    id: "rate-source-pill",
    name: "Rate Source Pill",
    category: "Operations",
    description: "A compact label for whether a supplier offer is a filed contract, a stored tariff, or an indicative spot or market rate.",
    details: "Use on rate books and compare results so operators can see firm in-house prices beside market indications without mixing them up.",
    foundOn: [{ label: "Import rates", route: "/rates/import" }, { label: "Export rates", route: "/rates/export" }, { label: "Cross trade rates", route: "/rates/cross-trade" }, { label: "Domestic rates", route: "/rates/domestic" }, { label: "Components", route: "/components?component=rate-source-pill" }],
    componentCode: `export function RateSourcePill({ source, confidence }) {\n  return (\n    <span className="inline-flex items-center gap-1">\n      <StatusPill>{source}</StatusPill>\n      {confidence === "indicative" ? <StatusPill tone="amber">Indicative</StatusPill> : null}\n    </span>\n  )\n}`,
    usageCode: `<RateSourcePill source="contract" confidence="firm" />\n<RateSourcePill source="tariff" confidence="firm" />\n<RateSourcePill source="carrier-api" confidence="indicative" />`,
  },
  {
    id: "zone-lookup-field",
    name: "Zone Lookup Field",
    category: "Operations",
    description: "An origin or destination field that accepts a postcode or named area and keeps the value left-to-right.",
    details: "Use when a tariff may zone by postcode range or by area name. The same typed value is later mapped into each supplier’s own zone scheme.",
    foundOn: [{ label: "Import rates", route: "/rates/import" }, { label: "Export rates", route: "/rates/export" }, { label: "Cross trade rates", route: "/rates/cross-trade" }, { label: "Domestic rates", route: "/rates/domestic" }, { label: "Components", route: "/components?component=zone-lookup-field" }],
    componentCode: `export function ZoneLookupField({ id, label, value, onChange, placeholder }) {\n  return (\n    <label htmlFor={id}>\n      <span>{label}</span>\n      <Input id={id} value={value} dir="ltr" placeholder={placeholder} onChange={(event) => onChange(event.target.value)} />\n    </label>\n  )\n}`,
    usageCode: `<ZoneLookupField\n  id="origin"\n  label="Origin"\n  value={origin}\n  onChange={setOrigin}\n  placeholder="Postcode or area"\n/>`,
  },
  {
    id: "carrier-filter-control",
    name: "Carrier Filter Control",
    category: "Operations",
    description: "A carrier multi-select that can honour a customer-nominated haulier or widen back to every supplier in the list.",
    details: "Use on the rate book and Compare so GXO and XPO can sit in one table, then be isolated or excluded without opening a different screen.",
    foundOn: [{ label: "Import rates", route: "/rates/import" }, { label: "Domestic rates", route: "/rates/domestic" }, { label: "Components", route: "/components?component=carrier-filter-control" }],
    componentCode: `export function CarrierFilterControl({ carriers, value, onChange, nominatedCarrierName, nominatedLocked, onClearNominated }) {\n  return (\n    <div>\n      <MultiSelectMenu options={carriers} value={value} onValueChange={onChange} placeholder="All carriers" />\n      {nominatedCarrierName ? <p>Customer nominated: {nominatedCarrierName}</p> : null}\n      {nominatedLocked ? <button onClick={onClearNominated}>Compare all carriers</button> : null}\n    </div>\n  )\n}`,
    usageCode: `<CarrierFilterControl\n  carriers={["XPO Logistics", "GXO Logistics", "Palletline"]}\n  value={selectedCarriers}\n  onChange={setSelectedCarriers}\n  nominatedCarrierName="XPO Logistics"\n  nominatedLocked={honourNominated}\n  onClearNominated={() => setHonourNominated(false)}\n/>`,
  },
  {
    id: "market-rate-request-bar",
    name: "Market Rate Request Bar",
    category: "Operations",
    description: "A coverage strip that says whether a request is in tariffs, then lets the operator request indicative market or carrier-API spot rates.",
    details: "Use on the Compare view after direction, mode, and type are chosen. Keep the states calm: searching, ready, partial failure, and expired refresh. Do not treat indicative rows as a firm buy.",
    foundOn: [{ label: "Import rates", route: "/rates/import" }, { label: "Export rates", route: "/rates/export" }, { label: "Components", route: "/components?component=market-rate-request-bar" }],
    componentCode: `export function MarketRateRequestBar({ coverage, state, errorCount, onRequest, onRefresh }) {\n  return (\n    <Surface>\n      <StatusPill>{coverage}</StatusPill>\n      <p>This request is not sitting in our rate book.</p>\n      <Button onClick={state === "expired" ? onRefresh : onRequest}>Request market rates</Button>\n    </Surface>\n  )\n}`,
    usageCode: `<MarketRateRequestBar\n  coverage="uncovered"\n  state={marketState}\n  errorCount={1}\n  onRequest={requestMarketRates}\n  onRefresh={requestMarketRates}\n/>`,
  },
  {
    id: "tariff-compare-results",
    name: "Tariff Compare Results",
    category: "Operations",
    description: "One sortable table of supplier offers, mixing filed tariffs with indicative spot, and marking the best firm and best market price.",
    details: "Use when operators need to rank buy price and transit across carriers. Filter carriers separately; do not split this into a page per haulier.",
    foundOn: [{ label: "Import rates", route: "/rates/import" }, { label: "Export rates", route: "/rates/export" }, { label: "Components", route: "/components?component=tariff-compare-results" }],
    componentCode: `export function RateCompareResults({ offers, selectedId, onSelect }) {\n  return (\n    <DataTable\n      columns={compareColumns}\n      rows={offers}\n      selectedRowKey={selectedId}\n      onRowClick={onSelect}\n    />\n  )\n}`,
    usageCode: `<RateCompareResults\n  offers={rankedOffers}\n  selectedId={selectedOfferId}\n  onSelect={setSelectedOffer}\n/>`,
  },
  {
