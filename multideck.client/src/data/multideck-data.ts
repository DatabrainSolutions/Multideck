...
export const galleryComponents = [
  ...
  },
  {
    ...
    foundOn: [{ label: "Overview", route: "/" }, { label: "Customers", route: "/customers" }, { label: "Suppliers", route: "/suppliers" }, { label: "CRM accounts", route: "/crm/accounts" }, { label: "CRM contacts", route: "/crm/contacts" }, { label: "Warehouse inventory", route: "/warehouse/inventory" }, { label: "Components", route: "/components" }],
...
>
  ...
  },
  {
    ...
    foundOn: [{ label: "Customers", route: "/customers" }, { label: "Suppliers", route: "/suppliers" }, { label: "CRM leads", route: "/crm/leads" }, { label: "Bookings", route: "/bookings" }, { label: "Quotes", route: "/quotes" }, { label: "Settings", route: "/settings" }, { label: "Compliance controls", route: "/compliance/screening" }, { label: "Components", route: "/components" }],
...
/>`,
  ...
  },
  {
    ...
    foundOn: [{ label: "Every route", route: "/" }, { label: "Customers", route: "/customers" }, { label: "Suppliers", route: "/suppliers" }, { label: "CRM leads", route: "/crm/leads" }, { label: "CRM accounts", route: "/crm/accounts" }, { label: "CRM contacts", route: "/crm/contacts" }, { label: "CRM deals", route: "/crm/deals" }, { label: "Contact cards", route: "/crm/contact-cards" }, { label: "Bookings", route: "/bookings" }, { label: "Quotes", route: "/quotes" }, { label: "Warehouse inventory", route: "/warehouse/inventory" }, { label: "Components", route: "/components?component=dot-grid-loader" }],
...
<StateBlock icon={<DotGridLoader decorative />} title="Loading facilities" detail="" />`,
  },
  {
    ...
    foundOn: [{ label: "Customers", route: "/customers" }, { label: "Suppliers", route: "/suppliers" }, { label: "CRM accounts", route: "/crm/accounts" }, { label: "CRM contacts", route: "/crm/contacts" }, { label: "CRM deals", route: "/crm/deals" }, { label: "Warehouse inventory", route: "/warehouse/inventory" }, { label: "Facilities", route: "/warehouse/facilities" }, { label: "Items", route: "/warehouse/items" }, { label: "Goods in", route: "/warehouse/goods-in" }, { label: "Warehouse orders", route: "/warehouse/orders" }, { label: "Customer purchase orders", route: "/warehouse/purchase-orders" }, { label: "Sales ledger", route: "/finance/receivables" }, { label: "Purchase ledger", route: "/finance/payables" }, { label: "Cash & allocations", route: "/finance/cash" }, { label: "Components", route: "/components?component=register-toolbar" }],
