...
export const warehouseGoodsOutFlowSteps = [
  { id: "order", label: "Order", detail: "Check allocation, labels, and customer dispatch notes.", tone: "blue" as StatusTone },
  { id: "pick", label: "Pick stock", detail: "Scan stock from bins and record shortages as they happen.", tone: "amber" as StatusTone },
  { id: "stage", label: "Stage", detail: "Move picked stock to the dispatch door or temperature zone.", tone: "teal" as StatusTone },
  { id: "dispatch", label: "Dispatch", detail: "Load, seal, hand off, and close the pick.", tone: "green" as StatusTone },
] as const

export const warehouseGoodsOutPicks = [
  {
    id: "GOUT-6710",
    customer: "Marlow Apparel Ltd",
    name: "Thermal activewear Manchester wave",
    orderRef: "SO-MAR-4481",
    window: "Due 14:00",
    owner: "JL",
    status: "Picking",
    tone: "amber" as StatusTone,
    progress: 54,
    nextStep: "Scan remaining A03 reserve cartons",
    stepId: "pick",
    savedAt: "Saved 6 min ago",
    lines: [
      { id: "gout-6710-thermal-top", product: "Thermal base layer tops", sku: "MAR-THM-201", required: 260, picked: 214, unit: "ctn", location: "A03-02-04", status: "Picking", tone: "amber" as StatusTone, note: "Aisle A reserve still open" },
      { id: "gout-6710-thermal-leg", product: "Thermal leggings", sku: "MAR-THM-244", required: 160, picked: 160, unit: "ctn", location: "A03-03-01", status: "Picked", tone: "green" as StatusTone, note: "Ready for staging" },
    ],
  },
  {
    id: "GOUT-6708",
    customer: "Black Forest Foods",
    name: "Black Forest chilled order split",
    orderRef: "SO-BFF-8841",
    window: "Cold chain 18:30",
    owner: "EM",
    status: "Claimed",
    tone: "teal" as StatusTone,
    progress: 42,
    nextStep: "Confirm cold-chain labels before staging",
    stepId: "order",
    savedAt: "Saved 18 min ago",
    lines: [
      { id: "gout-6708-meal-pack", product: "Chilled meal packs", sku: "BFF-CHL-082", required: 82, picked: 0, unit: "ctn", location: "Cold 2", status: "Ready", tone: "teal" as StatusTone, note: "Temperature log ready" },
      { id: "gout-6708-gel-pack", product: "Gel pack inserts", sku: "BFF-GEL-018", required: 18, picked: 0, unit: "ctn", location: "Cold 2 prep", status: "Label check", tone: "amber" as StatusTone, note: "Carrier label approval pending" },
    ],
  },
  {
    id: "GOUT-6704",
    customer: "Black Forest Foods",
    name: "Chilled meal packs staged for handoff",
    orderRef: "SO-BFF-8798",
    window: "18:30 cutoff",
    owner: "WC",
    status: "Staged",
    tone: "green" as StatusTone,
    progress: 82,
    nextStep: "Load to carrier and close dispatch",
    stepId: "dispatch",
    savedAt: "Saved today",
    lines: [
      { id: "gout-6704-meal-pack", product: "Chilled meal packs", sku: "BFF-CHL-082", required: 82, picked: 82, unit: "ctn", location: "Cold 2 door", status: "Staged", tone: "green" as StatusTone, note: "Ready for driver handoff" },
    ],
  },
  {
    id: "GOUT-6698",
    customer: "Atlas Office Supply",
    name: "Modular desk pod trailer load",
    orderRef: "SO-AOS-5108",
    window: "Tomorrow",
    owner: "EM",
    status: "Loaded",
    tone: "blue" as StatusTone,
    progress: 96,
    nextStep: "Close trailer seal and dispatch paperwork",
    stepId: "dispatch",
    savedAt: "Saved yesterday",
    lines: [
      { id: "gout-6698-desk-pod", product: "Modular desk pod", sku: "AOS-DESK-301", required: 82, picked: 82, unit: "units", location: "Door 4", status: "Loaded", tone: "blue" as StatusTone, note: "Hamburg groupage trailer" },
    ],
  },
] as const

export const warehouseGoodsInSources = ["Document / PO", "Scratch"] as const

export const warehouseGoodsInFlowSteps = [
  { id: "source", label: "Start", detail: "Choose PO, delivery note, or scratch entry.", tone: "teal" as StatusTone },
  { id: "setup", label: "Order setup", detail: "Confirm products, expected units, and missing data.", tone: "amber" as StatusTone },
  { id: "arrival", label: "Arrival", detail: "Pause here if the physical delivery has not arrived yet.", tone: "blue" as StatusTone },
  { id: "receive", label: "Check stock", detail: "Check actual pallets, IBCs, cartons, and units.", tone: "blue" as StatusTone },
  { id: "exceptions", label: "Exceptions", detail: "Capture shortage, overage, or damage evidence.", tone: "red" as StatusTone },
  { id: "summary", label: "Finish", detail: "Send receipt summary and move stock to putaway.", tone: "green" as StatusTone },
] as const

export const warehouseGoodsInReceipts = [
  {
    id: "GIN-8821",
    customer: "Bauhaus Importe GmbH",
    supplier: "Ningbo Homeware Co",
    source: "PO BAU-CREF-912",
    deliveryNote: "DN-4408",
    booking: "Dock 3 - 11:30",
    contact: "David Wallace",
    owner: "EM",
    status: "Receiving",
    tone: "teal" as StatusTone,
    progress: 68,
    expected: "2 pallets · 6 IBCs",
    actual: "2 pallets · 5 IBCs",
    nextAction: "Photograph damaged lamp cartons and send the receipt variance.",
    completeness: [
      { label: "Booking accepted", status: "Done", tone: "green" as StatusTone },
      { label: "Expected stock", status: "Complete", tone: "green" as StatusTone },
      { label: "Damage evidence", status: "Needed", tone: "red" as StatusTone },
    ],
    lines: [
      { id: "gin-8821-lamps", product: "Ceramic table lamp", sku: "BAU-LMP-220", expected: 320, actual: 318, unit: "ctn", condition: "2 damaged", status: "Damage", tone: "red" as StatusTone, location: "B02-QA", note: "Corner crush on pallet 2", photoCount: 2 },
      { id: "gin-8821-shades", product: "Linen shade cartons", sku: "BAU-SHD-118", expected: 180, actual: 180, unit: "ctn", condition: "Clear", status: "Matched", tone: "green" as StatusTone, location: "B02-03-04", note: "Ready for barcode print", photoCount: 0 },
      { id: "gin-8821-bases", product: "Lamp base spares", sku: "BAU-SPR-044", expected: 140, actual: 132, unit: "ctn", condition: "Short", status: "Variance", tone: "amber" as StatusTone, location: "B02-QA", note: "8 cartons short vs delivery note", photoCount: 0 },
    ],
    putaway: [
      { label: "Barcode labels", value: "6 labels ready", tone: "teal" as StatusTone },
      { label: "Putaway route", value: "B02 homeware · QA first", tone: "amber" as StatusTone },
      { label: "Customer receipt", value: "Draft ready", tone: "blue" as StatusTone },
    ],
  },
  {
    id: "GIN-8824",
    customer: "Marlow Apparel Ltd",
    supplier: "Yuhang Outerwear",
    source: "Supplier delivery note",
    deliveryNote: "YH-DN-8814",
    booking: "Dock 5 - 13:00",
    contact: "Charlotte Bucknell",
    owner: "JL",
    status: "Need setup",
    tone: "amber" as StatusTone,
    progress: 34,
    expected: "Product setup missing",
    actual: "Awaiting order",
    nextAction: "Add rain shell SKUs before the order arrives.",
    completeness: [
      { label: "Booking accepted", status: "Done", tone: "green" as StatusTone },
      { label: "Product setup", status: "Missing", tone: "amber" as StatusTone },
      { label: "Customer breakdown", status: "Chase", tone: "amber" as StatusTone },
    ],
    lines: [
      { id: "gin-8824-rain", product: "Rain shell jackets", sku: "MAR-RSJ-118", expected: 780, actual: 0, unit: "ctn", condition: "Awaiting arrival", status: "Expected", tone: "amber" as StatusTone, location: "A03 reserve", note: "Needs product confirmation before scan", photoCount: 0 },
      { id: "gin-8824-trims", product: "Accessory trim cartons", sku: "MAR-ACC-042", expected: 64, actual: 0, unit: "ctn", condition: "Unconfirmed SKU", status: "Setup", tone: "red" as StatusTone, location: "Setup needed", note: "Add item to product master", photoCount: 0 },
    ],
    putaway: [
      { label: "Barcode labels", value: "Blocked by setup", tone: "red" as StatusTone },
      { label: "Putaway route", value: "A03 outerwear reserve", tone: "blue" as StatusTone },
      { label: "Customer receipt", value: "Wait for arrival", tone: "neutral" as StatusTone },
    ],
  },
  {
    id: "GIN-8817",
    customer: "Mediterranean Spice Trading",
    supplier: "Piraeus Spice Co",
    source: "PO MST-HRB-7004",
    deliveryNote: "PHYTO-7719",
    booking: "Dock 1 - 09:15",
    contact: "Mina Solari",
    owner: "WC",
    status: "Putaway",
    tone: "green" as StatusTone,
    progress: 92,
    expected: "180 cartons",
    actual: "180 cartons",
    nextAction: "Print remaining bin labels and confirm D02 putaway.",
    completeness: [
      { label: "Booking accepted", status: "Done", tone: "green" as StatusTone },
      { label: "Phytosanitary cert", status: "Checked", tone: "green" as StatusTone },
      { label: "Putaway scan", status: "Open", tone: "blue" as StatusTone },
    ],
    lines: [
      { id: "gin-8817-herbs", product: "Dried herb cartons", sku: "MST-HRB-072", expected: 180, actual: 180, unit: "ctn", condition: "Clear", status: "Matched", tone: "green" as StatusTone, location: "D02-05-01", note: "Phyto cert checked", photoCount: 1 },
    ],
    putaway: [
      { label: "Barcode labels", value: "Printed", tone: "green" as StatusTone },
      { label: "Putaway route", value: "D02 food ambient", tone: "green" as StatusTone },
      { label: "Customer receipt", value: "Sent", tone: "green" as StatusTone },
    ],
  },
] as const
...
export const galleryComponents = [
  ...
  },
  {
    ...
    name: "Warehouse Pick Resume Table",
    category: "Operations",
    description: "A dense resume table for open goods-in and goods-out picks underneath the Kanban board.",
    details: "Use under Goods In and Goods Out boards when operators need to scan many partial picks and click a row to resume the right flow at the saved step. Keep the table dense, stable, horizontally scrollable, and focused on one editable expected date, customer number, progress, status, name, owner, and next step.",
    foundOn: [{ label: "Warehouse goods in/out", route: "/warehouse?tab=goods-in" }, { label: "Components", route: "/components?component=warehouse-pick-resume-table" }],
    componentCode: `export function WarehousePickResumeTable({ rows, onOpenPick }) {\n  return (\n    <WarehouseInventoryTable\n      rows={rows}\n      columns={[expectedDateColumn, progressColumn, statusColumn, customerNumberColumn, nameColumn, ownerColumn, nextStepColumn]}\n      minWidth={1280}\n      onRowClick={onOpenPick}\n    />\n  )\n}`,
    usageCode: `<WarehousePickResumeTable\n  title="Open goods-in picks"\n  meta="Click a row to resume the intake flow from the step last reached."\n  rows={goodsInRows}\n  onOpenPick={(row) => openGoodsInFlow(row.id)}\n/>\n\n<WarehousePickResumeTable\n  title="Open goods-out picks"\n  meta="Click a row to resume picking, staging, or dispatch."\n  rows={goodsOutRows}\n  onOpenPick={(row) => openGoodsOutFlow(row.id)}\n/>`,
  },
  {
    id: "warehouse-goods-in-flow",
    name: "Warehouse Goods In Wizard",
    category: "Operations",
    description: "A compact booking-style goods-in wizard for creating or resuming one pick from a PO, delivery note, or scratch intake.",
    details: "Use from the Warehouse New pick action or from a pick resume table row. The Goods In Kanban remains the operational board; the resume table owns the list of drafts, while this wizard focuses on the active pick, waiting for delivery, dense stock checks, exception evidence, receipt summaries, and barcode handoff.",
    foundOn: [{ label: "Warehouse New pick", route: "/warehouse?new-pick=goods-in" }, { label: "Components", route: "/components?component=warehouse-goods-in-flow" }],
    componentCode: `export function WarehouseGoodsInFlow({ initialReceiptId, onBack }) {\n  const [selectedReceiptId, setSelectedReceiptId] = useState(initialReceiptId)\n  const [activeStep, setActiveStep] = useState(getInitialGoodsInStep(selectedReceipt))\n\n  return (\n    <div className="grid gap-3">\n      <GoodsInStepRail activeStep={activeStep} onChange={setActiveStep} />\n      <GoodsInStockCheckTable lines={lines} onAdjust={adjustLine} />\n      <GoodsInExceptionPanel line={selectedLine} onToggleEvidence={toggleEvidence} />\n      <GoodsInReceiptSummary receipt={selectedReceipt} onSend={sendReceipt} onPrint={printBarcodes} />\n    </div>\n  )\n}`,
    usageCode: `<WarehouseGoodsInFlow\n  initialReceiptId={selectedGoodsInPickId}\n  onBack={() => setShowGoodsInWizard(false)}\n/>\n\n// Launch from New pick for a blank intake, or from WarehousePickResumeTable to resume a saved pick.`,
  },
  {
...
export const galleryIcons = {
  ...
  "warehouse-pick-resume-table": ClipboardCheck,
  "warehouse-goods-in-flow": PackageCheck,
