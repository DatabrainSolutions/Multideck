...
export const galleryComponents = [
  ...
  },
  {
    ...
    name: "Metric Card",
    category: "Data",
    description: "A calm KPI block for the overview header, built for fast scanning rather than loud dashboard display.",
    details: "Use one metric per card. Keep labels short, scope explicit, and deltas plain.",
...
export const galleryCategories = ["All", "Design System", "Foundation", "Navigation", "Data", "Feedback", "Operations"]
