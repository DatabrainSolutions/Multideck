...
export const galleryComponents = [
  ...
  },
  {
    ...
    details: "Every pill rendered inside an operator table uses the filled green, yellow, red, blue, orange, or purple Figma palette with exact light and dark theme pairs. Teal and neutral table pills use the approved blue information family. Pills outside tables keep the quieter surface shell and leading dot.",
...
// access the same authenticated Inbox action is completed by Dexter.`,
  ...
  },
  {
    ...
    foundOn: [{ label: "Customers", route: "/customers" }, { label: "CRM leads", route: "/crm/leads" }, { label: "Bookings", route: "/bookings" }, { label: "Quotes", route: "/quotes" }, { label: "Settings", route: "/settings" }, { label: "Components", route: "/components" }],
...
/>`,
  ...
  },
  {
    ...
    foundOn: [{ label: "Quotes", route: "/quotes" }, { label: "Customers", route: "/customers" }, { label: "CRM leads", route: "/crm/leads" }, { label: "CRM accounts", route: "/crm/accounts" }, { label: "CRM contacts", route: "/crm/contacts" }, { label: "Bookings", route: "/bookings" }, { label: "Rates & contracts", route: "/rates" }, { label: "Users", route: "/settings?tab=users" }, { label: "Permissions", route: "/settings?tab=permissions" }, { label: "Facilities", route: "/warehouse/facilities" }, { label: "Locations", route: "/warehouse/locations" }, { label: "Items", route: "/warehouse/items" }, { label: "Purchase orders", route: "/warehouse/purchase-orders" }, { label: "Components", route: "/components" }],
