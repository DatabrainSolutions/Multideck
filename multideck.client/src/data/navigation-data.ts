...
export const sidebarAreas: SidebarArea[] = [
  ...
  },
  {
    ...
    destinations: [
      ...
      { id: "finance-administration", label: "Overview", icon: LayoutDashboard, route: "/finance/administration" },
      { id: "finance-systems", label: "Accounting systems", icon: Cloud, route: "/finance/systems" },
      { id: "finance-currencies", label: "Currencies & FX", icon: Globe2, route: "/finance/currencies" },
      { id: "finance-banks", label: "Bank accounts", icon: CreditCard, route: "/finance/banks" },
      { id: "finance-ledger", label: "General ledger", icon: ListOrdered, route: "/finance/ledger" },
      { id: "finance-tax", label: "Tax", icon: BadgeCheck, route: "/finance/tax" },
      { id: "finance-documents", label: "Documents", icon: FileText, route: "/finance/documents" },
      { id: "finance-mappings", label: "Mappings", icon: SlidersHorizontal, route: "/finance/mappings" },
      { id: "finance-compliance", label: "Compliance", icon: BadgeCheck, route: "/finance/compliance" },
      { id: "finance-controls", label: "Controls & audit", icon: ClipboardCheck, route: "/finance/controls" },
      {
