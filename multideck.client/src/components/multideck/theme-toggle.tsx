...
export function ThemeToggle({ className, compact = false, showAppearanceLabel = true }: ThemeToggleProps) {
  ...
  useEffect(() => {
    setPendingTheme((pending) => (pending === null || pending === resolvedTheme ? null : pending))
  }, [resolvedTheme])
