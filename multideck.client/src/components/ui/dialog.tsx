...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl bg-muted/50 p-4 shadow-[var(--md-stroke-top)] sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
