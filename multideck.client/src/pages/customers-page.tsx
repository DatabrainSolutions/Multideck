      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent className="max-h-[88vh] overflow-y-auto border-0 bg-[var(--md-surface)] text-[var(--md-ink)] shadow-[var(--md-shadow-lift)] sm:max-w-[560px]">
          ...
          <form className="grid gap-4" onSubmit={submitNewCustomer}>
            ...
            <AddressSearch label={addressFieldLabel(newCustomer.countryCode, "line1")} value={newCustomer.addressLine1 ?? ""} onChange={value => updateNewCustomer("addressLine1", value || null)} onSelect={address => setNewCustomer(current => ({ ...current, addressLine1: address.line1, townCity: address.townCity, postZipCode: address.postZipCode, countryCode: address.countryCode }))} />
            ...
            <AddressSearch field="postZipCode" label={addressFieldLabel(newCustomer.countryCode, "postZipCode")} value={newCustomer.postZipCode ?? ""} onChange={value => updateNewCustomer("postZipCode", value || null)} onSelect={address => setNewCustomer(current => ({ ...current, addressLine1: address.line1, townCity: address.townCity, postZipCode: address.postZipCode, countryCode: address.countryCode }))} />
            <div className="grid gap-4 sm:grid-cols-2">
